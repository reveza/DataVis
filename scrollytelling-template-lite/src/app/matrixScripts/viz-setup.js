...
export function createBubbles(g, data, r, color, tip){
...
export function getLegend(g, width, height, color, option){
    var boxSize = 10;
...
export function addXAxis(g, xAxis, yAxis, height, width){
    g.append("g")
      .attr("class","x axis")
